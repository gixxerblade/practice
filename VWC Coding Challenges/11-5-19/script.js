...
function api(delay = 2000) {
  ...
  joke.appendChild(document.createTextNode(randJoke));
  source.appendChild(document.createTextNode(randSrc));
  ...
  return new Promise(function(resolve, reject) {
    if (!Number(delay)) {
      setTimeout(function() {
        reject(
          "Argument received not an integer. Make it an integer you joker"
        );
      }, 10000);
    } else {
      setTimeout(function() {
